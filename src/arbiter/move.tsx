...
export const movePiece = ({position, piece, rank, file, x, y}: {position: string[][], piece: string, rank: number, file: number, x: number, y: number}): string[][] => {
...
export const movePawn = ({position, piece, rank, file, x, y}: {position: string[][], piece: string, rank: number, file: number, x: number, y: number}): string[][] => {
    const newPosition: string[][] = copyPosition(position)
